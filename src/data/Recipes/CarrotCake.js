...
export const CarrotCake = {
  ...
  ingredients: [
    ...
    Sugar("2 cups"),
    Oil("1 1/2 cup"),
    Carrots("3 cups", { type: "Shredded" }),
    Pecans("1 1/2 cup", { parens: "diced" }),
    Eggs(4),
    Cheese("8 oz", { type: "Cream", parens: "for the frosting" }),
    Sugar("1 box (16 oz)", { type: "Powdered", parens: "for the frosting" }),
    Butter("1/4 cup", { parens: "for the frosting" }),
    VanillaExtract("2 tsp", { parens: "for the frosting" }),
  ],
  directions: [
