...
export const CarrotCake = {
  ...
  directions: [
    ...
    {
      type: "step",
      text: "add 1 egg at a time while beating, 2 minutes on medium speed",
    },
    ...
    {
      type: "step",
      text: "put a toothpick in to check if it is done, if it comes out clean its finished, if it come out sticky cook it longer.",
    },
