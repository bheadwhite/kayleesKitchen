...
export const Lasagna = {
  ...
  directions: [
    ...
    {
      type: "step",
      text: "2 big stove pans, 1 for boiling noodles and 1 for cooking the meat",
    },
    { type: "section", text: "Meat" },
    {
      type: "step",
      text: "cook low heat onion and garlic til lightly brown in a pan",
    },
    { type: "step", text: "add in ground beef and mix til meat is cooked" },
    {
      type: "step",
      text: "add all tomatoes (diced, sauce, and paste) with salt, and basil.",
    },
    ...
    {
      type: "step",
      text: "start with a little meat sauce to grease the bottom of the pan",
    },
    ...
    {
      type: "step",
      text: "following the cheese comes half of the meat sauce. ",
    },
