...
export const CookiesNCremeCookies = {
  ...
  directions: [
    ...
    {
      type: "step",
      text: "In a large bowl, cream butter and sugars together and then add pudding mix until blended. Stir in the eggs and vanilla.",
    },
    {
      type: "step",
      text: "In a seperate bowl, combine the flour and baking soda with a whisk then add it to the wet ingredients.",
    },
    {
      type: "step",
    ...
    {
      type: "step",
      text: "Bake for 10 minutes in preheated oven until cookies tops barely have a touch of brown (do not over bake).",
    },
  ],
};
