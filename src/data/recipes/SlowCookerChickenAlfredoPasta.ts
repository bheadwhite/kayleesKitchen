...
export const SlowCookerChickenAlfredoPasta = {
  ...
  directions: [
    ...
    {
      type: "step",
      text: "Pour Alfredo sauce, pesto, and tomatoes(undrained) on top of chicken.",
    },
    { type: "section", text: "Cook" },
    {
      type: "step",
      text: "Cook on low heat for 5-6 hours (or high heat for 3-4 hours) or until chicken is cooked through.",
    },
    {
      type: "step",
      text: "Near the end of the cooking time, cook the pasta according to the package directions and drain well.",
    },
    {
      type: "step",
      text: "Remove chicken rom slow cooker and shred using 2 forks (it should come apart fairly easy).",
    },
    {
      type: "step",
      text: "Add the chicken and pasta back to slow cooker and mix together.",
    },
    { type: "section", text: "Serve" },
    {
      type: "step",
      text: "Serve topped with fresh Parmesan cheese, fresh basil, and fresh diced tomatoes. (optional)",
    },
  ],
};
