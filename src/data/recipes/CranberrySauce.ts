...
export const CranberrySauce = {
  ...
  directions: [
    ...
    {
      type: "step",
      text: "In a 2 quart saucepan, heat brown sugar and OJ to boiling over medium heat, stirring frequently.",
    },
    { type: "step", text: "Boil for 5 minutes." },
    { type: "step", text: "Stir in cranberries, heat to boiling." },
    {
      type: "step",
      text: "Boil about 5 minutes, stir frequently until cranberries are popped and mixture has thickened.",
    },
    { type: "step", text: "Stir in orange peel + rasperries" },
    { type: "section", text: "Cool" },
    {
      type: "step",
      text: "Cover and refrigerate about 3 hours, or until chilled.",
    },
  ],
};
