...
import { Checkbox, TextField } from "src/components/finalForm";
...
const AddIngredient = () => {
  ...
  const addIngredientRef: React.MutableRefObject<HTMLDivElement | null> =
    useRef(null);
  const { change } = useForm();
  const { values } = useFormState<IngredientFormValues>();
