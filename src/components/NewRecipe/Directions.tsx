...
const Directions = () => {
  ...
  const stepRef: React.MutableRefObject<HTMLDivElement | null> = useRef(null);
  const sectionRef: React.MutableRefObject<HTMLDivElement | null> =
    useRef(null);
  ...
  const handleDeleteSection = (index: number | null) => {
